...
from AdaptiveNerf.utils import model_utils
...
class NerfModel(nn.Module):
    ...
    def __init__(
        ...
        net_activation: Callable[..., Any] = nn.ReLU(),  # MLP activation
        ...
        rgb_activation: Callable[..., Any] = nn.Sigmoid(),  # Output RGB activation.
        sigma_activation: Callable[..., Any] = nn.ReLU(),  # Output sigma activation.
